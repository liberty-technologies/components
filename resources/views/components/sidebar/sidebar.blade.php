<aside
    class="border-primary-300 bg-primary-200 dark:border-primary-600 dark:bg-primary-700 fixed inset-y-0 left-0 top-0 z-20 h-full w-44 flex-shrink-0 flex-col border-r-2 pt-16 print:hidden sm:w-64 xl:flex"
